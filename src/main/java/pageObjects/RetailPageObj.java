...
public class RetailPageObj extends Base {
	...
	// now we need to store UI WebElement in a private WebElement using @FindBy
	// annotations of PageFactory class.
	// we need to create action to perform
